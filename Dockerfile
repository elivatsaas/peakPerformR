...
# Update apt-get and install system dependencies required for R package compilation
...
# Install plumber and required packages using install2.r
# install2.r often handles R package dependencies well.
# The --error flag stops the build if any package fails.
RUN install2.r --error --deps TRUE \
    ...
    logger \
    debugme \
 && rm -rf /tmp/downloaded_packages/ # Clean up downloaded package sources
